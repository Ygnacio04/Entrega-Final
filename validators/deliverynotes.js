...
const validatorUpdateDeliveryNote = [
    ...
    check('status')
        .optional()
        .isIn(['draft', 'pending', 'signed', 'cancelled']).withMessage('Invalid status value'),
    (req, res, next) => validateResults(req, res, next)
];
...
module.exports = { validatorCreateDeliveryNote, validatorUpdateDeliveryNote, validatorGetDeliveryNote };